...
**Status**: `in progress` — S1 (F-SYNC-001/002) · S2 (F-RESTORE-001) · S3 (F-SPACE-001 서버 + 학습자 join · F-CONSOLE-001 웹 콘솔 셸: 로그인(dev)·첫 space·홈·roster) · S4 (F-PLAN-001 서버 + 기기 파생 + 웹 빌더) · S5 (F-TCH-001 §10) · S6 (F-ENT-001: entitlements · tier · paywall · console billing) 구현됨 2026-09-21; S7 (F-PLAN-001 / F-TCH-001 / F-ENT-001 / F-SCHOOL-001) 은 아직 proposal
**작성일**: 2026-09-19
...
| S6 | F-ENT-001 | `entitlements` + `tier.ts` 확장 + Stripe Checkout/webhook + F-IAP-001 수렴 — **구현됨 2026-09-21** (PR 1 서버 + tier · PR 2 앱 paywall · PR 3 콘솔 billing). 가격·Stripe 키는 오너 (T-051) | 2.5 d |
